...
<html>
    ...
    <body>
        ...
        <form name="formEditarHospede">
            ...
            <p>Nome usuário:<input value="<?=$DadosCadastro->GetUsuario();?>" maxlength="20" size="20" tabindex="17" name="NomeUsuario"></p>
            <p>Senha:<input value="<?=$DadosCadastro->GetSenha();?>" maxlength="12" size="12" tabindex="18" name="SenhaAcesso" type="password"></p>
            ...
            <?php } else {?>
            <p>Para editar os dados cadastrais, você precisa efetuar o login!</p><br>
