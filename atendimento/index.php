     ...
     <div class="main">
      <div class="header">
       ...
       <div class="barra-menu">
        <div class="dropdown">
         <button class="dropbutton" onclick="carregar('adm_consulta_apartamento.php')">Reserva</button>
        </div>
        <div class="dropdown">
         <button class="dropbutton">Hóspedes</button>
         <div class="dropdown-opcoes">
             <a onclick="carregar('adm_cadastro_hospede.php')" href="#">Adicionar</a>
             <a onclick="carregar('adm_editar_cadastro.php')" href="#">Editar dados</a>
             <a onclick="carregar('adm_selecao_hospede.php')" href="#">Selecionar</a>
         </div>
        </div>
        <div class="dropdown">
         <button class="dropbutton" onclick="carregar('adm_login.html')">Login</button>
        </div>
       </div>
      </div>
